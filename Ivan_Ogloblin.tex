...
%		\end{itemize}
	...
	\cventry{}{}{Smashy Ninja}{2018 \vspace{-1.0em}}{}{
		% Detailed achievements:%
		\begin{itemize}
			\item I made a mobile game with Unity 3d engine, published in Google Play, play it right now! \href{https://play.google.com/store/apps/details?id=com.PixArt.Pouc}{(\textcolor{blue}{playmarket}) }\href{https://github.com/StudioShader/Smashy-Ninja}{(\textcolor{blue}{github})}
	\end{itemize}}

	\cventry{}{}{Archiver}{ 2019 \vspace{-1.0em}}{}{
		% Detailed achievements:%
		\begin{itemize}
			\item  C++ Used Huffman algorithm in implementation for data compression and decompression \href{https://github.com/StudioShader/huffman-archiver}{(\textcolor{blue}{github})}
	\end{itemize}}
	% \vspace{1.0em}
...
%	\end{itemize}}
	...
	\cventry{}{}{DoNotExplode}{2019 \vspace{-1.0em}}{}{
		% Detailed achievements:%
		\begin{itemize}
			\item Procedurally generate self-intersecting path for ball to bounce with a certain rules \href{https://github.com/StudioShader/DoNotExplode}{(\textcolor{blue}{github})}
	\end{itemize}}
	...
	\cventry{}{}{ML-projects}{2019 \vspace{-1.0em}}{}{
		...
		\begin{itemize}
			...
			\item also contains realisation of K-means, SVM, Clustering and neural network algorithms \href{https://github.com/StudioShader/ML-Projects}{(\textcolor{blue}{github})}
	\end{itemize}}

	\cventry{}{}{RTV-redactor}{2020 \vspace{-1.0em}}{}{
		% Detailed achievements:%
		\begin{itemize}
			\item I wrote algorithm of recognition with ideas of interpolation angles and point structures \href{https://github.com/makselivanov/RTV_redactor}{(\textcolor{blue}{github})}
	\end{itemize}}
