...
\begin{document}
	...
	\section{Experience}
		...
		% Detailed achievements:%
		\begin{itemize}
			\item backend c\#/.netASP/EntityFramework/Autofac + frontend 3js/react/VR
		\end{itemize}}
	...
	\cventry{}{}{Archiver}{ 2019 \vspace{-1.0em}}{}{
		...
		\begin{itemize}
			...
			\item  C++ Used Huffman algorithm in implementation for data compression and decompression.
	\end{itemize}}
	% \vspace{1.0em}
...
%	\end{itemize}}
	...
	\section{Skills}
	\begin{itemize}
		\item C++, Python, C\#, C. Have experience in  Java, Kotlin, Haskell, Scala, SQL, Lean, Javascript
		\item ASPnet, EntityFramework, Microsoft Sql express, React, three.js, VR in three.js
