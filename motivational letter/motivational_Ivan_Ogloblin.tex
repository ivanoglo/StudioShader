...
\begin{document}
	...
	\recipient{Huawei internship commite}{}
	\date{June 05, 2022}
	\opening{Dear Sir/Madam,}
	\closing{Yours faithfully,}
	%	\enclosure[Attached]{curriculum vit\ae{}}          % use an optional argument to use a string other than "Enclosure", or redefine \enclname
	\makelettertitle
		I want to apply for the project "Automated unit test generation for Python language".
		
		I already have a lot of experience writing tests for Yandex recommendations structure, which was quite frustrating and took a lot of time. Our code base consisted of C++ scripts and Python scripts. They were used mainly to generate other scripts, so the testing was multi layered. Tests were not easy and I can only imagine how UTbot could write those automatically. I am passionate about unit testing and code analysis. 
		
		I always wanted to dig deeper into the processes of compilation and linking in python. Python is generally considered to be an easy language, so that means that all the hard work was made on the deeper level. I think it would really help my carrier to understand the intricacies of "How the whole system works".
		
		I meet all the requirements and I am confident that my experience, my educational background and interests will make me a great fit for this position!
